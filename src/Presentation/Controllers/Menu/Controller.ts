...
import Dto from '@Domain/Entities/Menu/Dto'
import ObjInterface from '@Domain/Entities/Menu/Interface'
import Serviceable from '@Domain/Entities/Menu/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Menu) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Menu) private schema: Schemable
	@inject(TYPES.MenuServiceableDomain) private service: Serviceable
