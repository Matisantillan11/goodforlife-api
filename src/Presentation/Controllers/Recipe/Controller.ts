...
import Dto from '@Domain/Entities/Recipe/Dto'
import ObjInterface from '@Domain/Entities/Recipe/Interface'
import Serviceable from '@Domain/Entities/Recipe/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/recipe'
	...
	@inject(TYPES.Validable) @named(TYPES.Recipe) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Recipe) private schema: Schemable
	@inject(TYPES.RecipeServiceableDomain) private service: Serviceable
